...
{    
    ...
    inline XmlElementPtr generatePluginState(Array<NodeUIPtr>& inputs, Array<NodeUIPtr>& outputs, Array<NodeUIPtr>& processors)
    {
        ...
        // {
        //     auto inputXml = generateNodeXml(input);
        ...
        // {
        //     auto outputXml = generateNodeXml(output);
        ...
        // {
        //     auto processorXml = generateNodeXml(processor);
