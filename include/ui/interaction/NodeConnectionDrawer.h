...
namespace NodeConnectionDrawer
{
    ...
    inline void drawConnection(Graphics& g, GraphEditor* graphEditor, NodeConnectorUI* startNode, NodeConnectorUI* endNode)
    {
        ...
        // auto startNode = (NodeUI*)(startNode->getParentComponent());
        // auto endNode = (NodeUI*)(endNode->getParentComponent());
